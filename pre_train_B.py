...
generator = build_generator(res_blocks=16, upscale_2_power=2, input_shape=lr_shape, final_activation="sigmoid")
...
generator.save_weights("generator_pretrained_B.weights.h5")
...
plt.legend()
plt.tight_layout()
plt.savefig('pre_training_losses_B.png')
plt.close()